...
export default function AboutTab() {
  ...
  const introVersions = [
    {
      paragraphs: [
        '我是謝子尉，目前就讀於中央大學資管所，我擅長系統架構設計與全端開發，會使用 Flask、Django、FastAPI 以及 DevOps 工具鏈（Kubernetes、Azure DevOps、ArgoCD）進行開發。',
      ],
      highlights: ['謝子尉', '系統架構設計與全端開發']
    },
    {
      paragraphs: [
        '同時我對 AI/ML 領域有濃厚興趣，特別是 GNN、時間序列預測等技術的應用，未來我的職涯目標是朝 MLOps 發展，專注於 AI Agent 與時間序列模型的部署與優化，期許能將機器學習模型穩定地落地到生產環境，創造實際價值。'
      ],
